<header class="absolute top-0 right-0 left-0 z-20 text-[#4c4c4c]" :class="{ 'top-8 sm:top-11 xl:top-8': document.body.classList.contains('admin-bar') }">
    <div
        ...
        <div class="hidden xl:block">
            <nav>
                <ul
                    ...
                    <li>
                        <a href="#what-we-do" class="hover:opacity-75">What we do?</a>
                    </li>
                    <li>
                        <a href="#why-we-do-this" class="hover:opacity-75">Why we do this?</a>
                    </li>
                    <li>
                        <a href="#cooperation" class="hover:opacity-75">Cooperation</a>
                    </li>
                    <li>
                        <a href="/salomon" class="hover:opacity-75">Salomon</a>
                    </li>
                    <li>
                        <a href="/team" class="hover:opacity-75">Team</a>
                    </li>
                    <li>
                            ...
                            <svg
                                ...
                                <defs>
                                    <clipPath id="clip0_35_754">
                                        <rect width="12" height="12" fill=""></rect>
                                    </clipPath>
                                </defs>
                            </svg>
                        </a>
                        <ul
                            class="absolute top-full mt-2 w-24 rounded bg-gray-800 shadow-lg"
                    ...
                    <li>
                        <a
                            href="/contact"
                            class="flex items-center gap-2 rounded-full bg-[var(--guide-me-lime)] pr-4 text-xs font-semibold whitespace-nowrap text-[var(--guide-me-dark)] shadow-lg hover:opacity-85">
                            <img
            ...
            <div
                ...
                <div class="mb-4 flex justify-end">
                    <button
                        ...
                        <svg class="h-6 w-6 pb-3" fill="" viewBox="0 0 24 24" stroke="#fff">
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                stroke-width="2"
                ...
                <nav class="flex-grow text-white">
                    <ul class="flex flex-col space-y-4 uppercase">
                        <li>
                            <a href="#what-we-do" class="" @click="mobileMenu = false">What we do?</a>
                        </li>
                        <li>
                            <a href="#why-we-do-this" class="" @click="mobileMenu = false">Why we do this?</a>
                        </li>
                        <li>
                            <a href="#cooperation" class="" @click="mobileMenu = false">Cooperation</a>
                        </li>
                        <li>
                            <a href="/salomon" class="" @click="mobileMenu = false">Salomon</a>
                        </li>
                        <li>
                            <a href="/contact" class="" @click="mobileMenu = false">Contact</a>
                        </li>
                        <li>
                            <a href="/team" class="" @click="mobileMenu = false">Team</a>
                        </li>
                        <li>
                            <a href="/blog" class="" @click="mobileMenu = false">Blog</a>
                        </li>
